...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Helper plugin which will allow to find Firebase App ID from GoogleService-Info.plist [iOS] or google-services.json [Android] using application identifier.'
  # spec.homepage      = "https://github.com/<GITHUB_USERNAME>/fastlane-plugin-find_firebase_app_id"
  spec.license       = "MIT"
